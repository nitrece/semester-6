...
long IRtdxExp::Open(LPCTSTR Channel_String, LPCTSTR Read_Write)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR;
...
long IRtdxExp::Read(VARIANT* pArr, long dataType, long numBytes)
{
	long result;
	static BYTE parms[] =
...
long IRtdxExp::ReadI2(short* pData)
{
	long result;
	static BYTE parms[] =
		VTS_PI2;
...
long IRtdxExp::ReadI4(long* pData)
{
	long result;
	static BYTE parms[] =
		VTS_PI4;
...
long IRtdxExp::ReadF4(float* pData)
{
	long result;
	static BYTE parms[] =
		VTS_PR4;
...
long IRtdxExp::ReadF8(double* pData)
{
	long result;
	static BYTE parms[] =
		VTS_PR8;
...
long IRtdxExp::ReadSAI1(VARIANT* pArr)
{
	long result;
	static BYTE parms[] =
		VTS_PVARIANT;
...
long IRtdxExp::ReadSAI2(VARIANT* pArr)
{
	long result;
	static BYTE parms[] =
		VTS_PVARIANT;
...
long IRtdxExp::ReadSAI4(VARIANT* pArr)
{
	long result;
	static BYTE parms[] =
		VTS_PVARIANT;
...
long IRtdxExp::ReadSAF4(VARIANT* pArr)
{
	long result;
	static BYTE parms[] =
		VTS_PVARIANT;
...
long IRtdxExp::ReadSAF8(VARIANT* pArr)
{
	long result;
	static BYTE parms[] =
		VTS_PVARIANT;
...
VARIANT IRtdxExp::ReadSAI2V(long* pStatus)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_PI4;
...
VARIANT IRtdxExp::ReadSAI4V(long* pStatus)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_PI4;
...
long IRtdxExp::WriteI2(short Data, long* numBytes)
{
	long result;
	static BYTE parms[] =
		VTS_I2 VTS_PI4;
...
long IRtdxExp::WriteI4(long Data, long* numBytes)
{
	long result;
	static BYTE parms[] =
		VTS_I4 VTS_PI4;
...
long IRtdxExp::WriteF4(float Data, long* numBytes)
{
	long result;
	static BYTE parms[] =
		VTS_R4 VTS_PI4;
...
long IRtdxExp::WriteF8(double Data, long* numBytes)
{
	long result;
	static BYTE parms[] =
		VTS_R8 VTS_PI4;
...
long IRtdxExp::Write(const VARIANT& Arr, long* numBytes)
{
	long result;
	static BYTE parms[] =
		VTS_VARIANT VTS_PI4;
...
long IRtdxExp::Seek(long MsgNum)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
long IRtdxExp::SeekData(long numBytes)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
long IRtdxExp::StatusOfWrite(long* numBytes)
{
	long result;
	static BYTE parms[] =
		VTS_PI4;
...
long IRtdxExp::GetNumMsgs(long* pNum)
{
	long result;
	static BYTE parms[] =
		VTS_PI4;
...
long IRtdxExp::GetChannelID(LPCTSTR Channel_String, long* chanId)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_PI4;
...
long IRtdxExp::GetMsgID(long* pMsgId)
{
	long result;
	static BYTE parms[] =
		VTS_PI4;
...
long IRtdxExp::GetMsgNumber(long* pMsgNum)
{
	long result;
	static BYTE parms[] =
		VTS_PI4;
...
long IRtdxExp::GetMsgLength(long* pLength)
{
	long result;
	static BYTE parms[] =
		VTS_PI4;
...
long IRtdxExp::EnableChannel(LPCTSTR ChannelName)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR;
...
long IRtdxExp::DisableChannel(LPCTSTR ChannelName)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR;
...
long IRtdxExp::GetChannelStatus(LPCTSTR ChannelName, long* pChannelStatus)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_PI4;
...
long IRtdxExp::ConfigureRtdx(short Mode, long MainBufferSize, long NumOfMainBuffers)
{
	long result;
	static BYTE parms[] =
...
long IRtdxExp::ConfigureLogFile(LPCTSTR FileName, long FileSize, short FileFullMode, short FileOpenMode)
{
	long result;
	static BYTE parms[] =
...
long IRtdxExp::GetRTDXRev(long* RevNum)
{
	long result;
	static BYTE parms[] =
		VTS_PI4;
...
long IRtdxExp::GetStatusString(BSTR* StatusString)
{
	long result;
	static BYTE parms[] =
		VTS_PBSTR;
...
long IRtdxExp::GetCapability(long* Capability)
{
	long result;
	static BYTE parms[] =
		VTS_PI4;
...
long IRtdxExp::RunDiagnostics(short TestType, long TestMode, long TestInfo)
{
	long result;
	static BYTE parms[] =
		VTS_I2 VTS_I4 VTS_I4;
...
CString IRtdxExp::GetDiagFilePath(short TestType)
{
	CString result;
	static BYTE parms[] =
		VTS_I2;
...
long IRtdxExp::SetProcessor(LPCTSTR Board, LPCTSTR Cpu)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR;
